...
class SubstationDialog(QtGui.QWidget):
    ...
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.LabelRole, self.r_posLabel)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.r_posLineEdit)
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.LabelRole, self.i_posLabel)
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.i_posLineEdit)
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.LabelRole, self.r_zeroLabel)
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.r_zeroLineEdit)
        ...
        self.formLayout.setWidget(7, QtGui.QFormLayout.LabelRole, self.i_zeroLabel)
        ...
        self.formLayout.setWidget(7, QtGui.QFormLayout.FieldRole, self.i_zeroLineEdit)
